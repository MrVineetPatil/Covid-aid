    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.backbtn_signup).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Analyse2.this, Analyse1.class));
            }
        });
        ...
        //pieChart.setCenterText("Above 60 Vs Gender");
...
//    }
    private ArrayList<PieEntry> dataValues1() {
        ...
        dataVals.add(new PieEntry(66, "Male"));
        dataVals.add(new PieEntry(34, "Female"));
        return dataVals;
    }
}
