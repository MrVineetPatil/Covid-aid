    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.backbtn_signup).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Analyse3.this, Analyse2.class));
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Analyse4.class);
...
//    }
    private ArrayList<PieEntry> dataValues1() {
        ...
        dataVals.add(new PieEntry(55, "Male"));
        dataVals.add(new PieEntry(45, "Female"));
        return dataVals;
    }
}
