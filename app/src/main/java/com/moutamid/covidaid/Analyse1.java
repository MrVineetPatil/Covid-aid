...
public class Analyse1 extends AppCompatActivity {
    PieChart pieChart;
    PieData pieData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analyse1);
        ...
        findViewById(R.id.backbtn_signup).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Analyse1.this,PredictionPage.class));
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),Analyse2.class);
    ...
    pieDataSet.setColors(ColorTemplate.JOYFUL_COLORS);
        ...
        pieChart.setCenterText("Impact of age");
...
//    }
    private ArrayList<PieEntry> dataValues1(){
        ...
        dataVals.add(new PieEntry(70,"Above 60 age"));
        dataVals.add(new PieEntry(30,"Below 60 age"));
        return dataVals;
    }
}